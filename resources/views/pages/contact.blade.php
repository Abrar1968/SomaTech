    ...
    <section class="pb-24">
        <div class="container">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div data-gsap="fade-up">
                    ...
                    <div class="space-y-6 mb-12">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 rounded-lg bg-[var(--color-accent)]/20 flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-[var(--color-text-muted)]">Remote-first, Serving Clients Worldwide</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            <a href="#" class="w-12 h-12 rounded-lg bg-[var(--color-bg-surface)] border border-[var(--color-border)] flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-accent)] hover:border-[var(--color-accent)] transition-colors">
                ...
                {{-- Contact Form --}}
                <div class="glass rounded-2xl p-8" data-gsap="fade-up" data-gsap-delay="0.2">
