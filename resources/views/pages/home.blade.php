<x-layouts.app>
    @php
        $seoTitle = null;
        $seoDescription =
            'Somaticx specializes in Website Development & Maintenance and App Development. Transform your digital presence with our expert team.';
    @endphp

    {{-- Hero Section - SRS FR-001 --}}
    <x-hero title="We Build <span class='gradient-text'>Digital Excellence</span>"
    ...
    <section
        class="relative py-8 overflow-hidden border-y border-white/5 bg-gradient-to-r from-bg-surface via-bg-primary to-bg-surface">
        {{-- Fade edges --}}
        <div
            class="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[var(--color-bg-primary)] to-transparent z-10">
        </div>
        <div
            class="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[var(--color-bg-primary)] to-transparent z-10">
        </div>
        ...
        <div class="flex animate-marquee whitespace-nowrap">
            ...
            @foreach ($technologies as $tech)
                <span
                    class="group inline-flex items-center mx-6 text-xl font-semibold text-text-muted hover:text-accent transition-all duration-300">
    ...
    <section class="section">
        ...
        <div class="absolute top-0 right-0 w-[600px] h-[600px] bg-accent/5 rounded-full blur-3xl pointer-events-none">
        </div>

        <div class="container relative">
            <x-section-heading badge="What We Do" title="Our <span class='gradient-text'>Services</span>"
                ...
                @empty
                    @foreach ([['title' => 'Website Development', 'tagline' => 'Custom web solutions', 'description' => 'From simple landing pages to complex web applications, we build websites that perform.', 'icon' => 'code'], ['title' => 'App Development', 'tagline' => 'Mobile-first approach', 'description' => 'Native and cross-platform mobile apps that deliver exceptional user experiences.', 'icon' => 'mobile'], ['title' => 'Website Maintenance', 'tagline' => 'Keep it running smoothly', 'description' => 'Ongoing support, updates, and optimization to keep your digital presence at its best.', 'icon' => 'settings']] as $index => $placeholder)
                        <div class="service-card group relative p-8 rounded-3xl bg-gradient-to-b from-white/5 to-transparent border border-white/5 hover:border-accent/30 transition-all duration-500"
                            ...
                            <div
                                class="absolute inset-0 rounded-3xl bg-gradient-to-r from-accent/10 to-accent-2/10 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-500 -z-10">
                            </div>

                            {{-- Icon --}}
                            <div class="relative w-16 h-16 mb-8">
                                <div
                                    class="absolute inset-0 bg-gradient-to-br from-accent to-accent-2 rounded-2xl rotate-6 group-hover:rotate-12 transition-transform duration-500">
                                </div>
                                <div
                                    class="absolute inset-0 bg-[var(--color-bg-surface)] rounded-2xl flex items-center justify-center">
                            ...
                            {{-- Content --}}
                            <h3 class="text-2xl font-bold font-display mb-2 group-hover:text-accent transition-colors">
                            ...
                            <a href="{{ route('services.index') }}"
                                ...
                                <span class="relative">
                                    Learn More
                                    <span
                                        class="absolute bottom-0 left-0 w-0 h-px bg-accent group-hover/link:w-full transition-all duration-300"></span>
                                </span>
            ...
            <div class="text-center mt-16">
                <a href="{{ route('services.index') }}"
                    class="inline-flex items-center gap-2 text-text-muted hover:text-white transition-colors group">
    ...
    <section class="section bg-gradient-to-b from-bg-surface to-bg-primary">
        <div class="container">
            <x-section-heading badge="Our Work" title="Featured <span class='gradient-text'>Projects</span>"
                ...
                @empty
                    @for ($i = 0; $i < 6; $i++)
                        <div class="project-card group relative rounded-2xl overflow-hidden bg-[var(--color-bg-elevated)] border border-white/5"
                            ...
                            style="transition: all 0.6s cubic-bezier(0.4, 0, 0.2, 1);">
                            <div
                                class="aspect-video bg-gradient-to-br from-accent/20 to-accent-2/20 relative overflow-hidden">
                                <div
                            ...
                            <div class="p-6">
                                <div class="flex items-center gap-2 mb-3">
                                    <span
                                        class="px-3 py-1 text-xs font-medium bg-accent/10 text-accent rounded-full">Web
                                        App</span>
                                </div>
                                <h3 class="text-lg font-semibold mb-2 group-hover:text-accent transition-colors">Project
                                    Title {{ $i + 1 }}</h3>
                                <p class="text-text-muted text-sm line-clamp-2">A brief description of this amazing
                                    project and what we achieved.</p>
                            </div>
                        </div>
                    @endfor
                @endforelse
            ...
            <div class="text-center mt-16">
                <a href="{{ route('portfolio.index') }}"
                    class="group relative inline-flex items-center gap-3 px-8 py-4 overflow-hidden rounded-full font-semibold transition-all duration-300">
                    <span
                        class="absolute inset-0 border-2 border-accent rounded-full group-hover:border-accent-2 transition-colors"></span>
                    <span
                        class="absolute inset-0 bg-accent/0 group-hover:bg-accent/10 rounded-full transition-colors"></span>
                    <span class="relative text-white">View All Projects</span>
                    <svg class="relative w-5 h-5 text-accent transform group-hover:translate-x-1 transition-transform"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                    </svg>
    ...
    <section class="section">
        ...
        <div class="absolute inset-0 pointer-events-none">
            <div
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-accent/5 to-accent-2/5 rounded-full blur-3xl">
            </div>
        </div>
        ...
        <div class="container relative">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                @empty
                    @foreach ([['value' => 120, 'label' => 'Projects Delivered', 'suffix' => '+', 'icon' => 'folder'], ['value' => 85, 'label' => 'Happy Clients', 'suffix' => '+', 'icon' => 'users'], ['value' => 5, 'label' => 'Years Experience', 'suffix' => '+', 'icon' => 'calendar'], ['value' => 99, 'label' => 'Uptime Guarantee', 'suffix' => '%', 'icon' => 'chart']] as $index => $placeholder)
                        <div class="relative text-center p-8 rounded-3xl bg-gradient-to-b from-white/5 to-transparent border border-white/5"
                            ...
                            style="transition: all 0.6s cubic-bezier(0.4, 0, 0.2, 1);">
                            <div
                                class="w-14 h-14 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-accent/20 to-accent-2/20 flex items-center justify-center">
                            ...
                            <div class="text-4xl md:text-5xl lg:text-6xl font-bold font-display mb-3">
                                <span class="gradient-text" x-text="count">0</span><span
                                    class="gradient-text">{{ $placeholder['suffix'] }}</span>
                            </div>
    ...
    <section class="section bg-bg-surface border-t border-white/5">
        {{-- Background decoration --}}
        <div class="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-white/10 to-transparent">
        </div>

        <div class="container">
            <x-section-heading badge="Testimonials" title="What Our <span class='gradient-text'>Clients Say</span>"
                ...
                @empty
                    @foreach ([['name' => 'John Smith', 'company' => 'TechCorp', 'role' => 'CEO', 'content' => 'Somaticx delivered an exceptional website that exceeded our expectations. Their attention to detail and technical expertise is unmatched.', 'rating' => 5], ['name' => 'Sarah Johnson', 'company' => 'StartupXYZ', 'role' => 'Founder', 'content' => 'Working with Somaticx was a pleasure from start to finish. They understood our vision and brought it to life perfectly.', 'rating' => 5], ['name' => 'Michael Chen', 'company' => 'InnovateCo', 'role' => 'CTO', 'content' => 'The mobile app Somaticx built for us has been a game-changer. Professional team, excellent communication, and outstanding results.', 'rating' => 5]] as $index => $placeholder)
                        <div class="testimonial-card relative p-8 rounded-3xl bg-[var(--color-bg-primary)] border border-white/5 hover:border-accent/20 transition-all duration-500"
                            ...
                            {{-- Content --}}
                            <p class="text-text-muted mb-8 leading-relaxed text-lg">"{{ $placeholder['content'] }}"
                            </p>
                            ...
                            <div class="flex items-center gap-4">
                                <div class="relative">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-br from-accent to-accent-2 rounded-full blur-sm">
                                    </div>
                                    <div
                                        class="relative w-14 h-14 rounded-full bg-gradient-to-br from-accent to-accent-2 flex items-center justify-center font-bold text-white text-lg">
                                        {{ strtoupper(substr($placeholder['name'], 0, 1)) }}
                                    </div>
                                </div>
                                <div>
                                    <p class="font-semibold text-white">{{ $placeholder['name'] }}</p>
                                    <p class="text-sm text-text-muted">{{ $placeholder['role'] }} at
    ...
    <section class="section">
        <div class="container">
            <div class="relative rounded-[2.5rem] overflow-hidden" x-data="{ visible: false }"
                ...
                <div class="absolute -top-24 -left-24 w-64 h-64 bg-accent/30 rounded-full blur-3xl animate-pulse">
                </div>
                <div class="absolute -bottom-24 -right-24 w-64 h-64 bg-accent-2/30 rounded-full blur-3xl animate-pulse"
                ...
                <div class="relative z-10 p-12 md:p-20 text-center">
                    ...
                    <p class="text-text-muted text-lg md:text-xl mb-10 max-w-2xl mx-auto">
                        Let's discuss how we can help bring your vision to life. Get in touch today for a free
                        consultation.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="{{ route('contact.index') }}"
                            class="group relative inline-flex items-center justify-center gap-2 px-8 py-4 overflow-hidden rounded-full font-semibold text-white transition-all duration-300">
                            ...
                            <svg class="relative w-5 h-5 transform group-hover:translate-x-1 transition-transform"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                            </svg>
                        ...
                        <a href="{{ route('portfolio.index') }}"
                            class="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full font-semibold text-white border-2 border-white/20 hover:border-white/40 transition-colors">
                            View Our Work
