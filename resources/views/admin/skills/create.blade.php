<x-layouts.admin title="Add Skill">
    <div class="space-y-6">
        {{-- Header --}}
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold font-display">Add Skill</h1>
                <p class="text-text-muted mt-1">Add a new technical skill to your portfolio</p>
            </div>
        </div>

        <form action="{{ route('admin.skills.store') }}" method="POST" class="max-w-2xl">
            @csrf
            ...
            <div class="bg-[var(--color-bg-surface)] rounded-2xl border border-white/5 p-6 space-y-5">
                ...
                <div class="space-y-2" x-data="{ proficiency: {{ old('proficiency', 75) }} }">
