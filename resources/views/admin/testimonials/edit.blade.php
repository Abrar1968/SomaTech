<x-layouts.admin title="Edit Testimonial">
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold font-display">Edit Testimonial</h1>
                <p class="text-text-muted mt-1">{{ $testimonial->client_name }}</p>
            </div>
        </div>

        <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST" enctype="multipart/form-data" class="grid lg:grid-cols-3 gap-6">
            @csrf
            @method('PUT')
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-[var(--color-bg-surface)] rounded-2xl border border-white/5 p-6 space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div x-data="{ rating: {{ old('rating', $testimonial->rating) }} }" class="flex gap-2">
                            @for($i = 1; $i <= 5; $i++)
                                <button
                                    type="button"
                                    @click="rating = {{ $i }}"
            ...
            <div class="space-y-6">
                ...
                <div class="bg-[var(--color-bg-surface)] rounded-2xl border border-white/5 p-6 space-y-5">
                    ...
                    <div
                        x-data="{ preview: '{{ $testimonial->client_photo ? Storage::url($testimonial->client_photo) : '' }}' }"
                        class="space-y-3"
                    >
                        <div
                ...
                <div class="bg-red-500/5 rounded-2xl border border-red-500/10 p-6 space-y-4">
                    ...
                    <p class="text-sm text-text-muted">Permanently delete this testimonial.</p>
